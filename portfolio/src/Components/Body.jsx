  ...
  return (
    ...
    >
      ...
      <div className="flex absolute h-full w-full top-20  justify-center md:top-40">
        ...
        <div className=" absolute flex flex-col w-16 h-60 border-2 border-gray-300 left-0 rounded-r-md justify-between">
          <div className=" LinkedIn border-2 w-10 rounded-md ml-2 mt-1 ">
            <a
              href="https://www.linkedin.com/in/thesurajgautam/"
              target="_blank"
            >
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 ml-2 my-1"
                fill="currentColor"
                viewBox="0 0 24 24"
                url="https://www.linkedin.com/in/thesurajgautam/"
              >
          ...
          <div className=" Youtube">
            <a href="https://www.youtube.com/@VroomVroomNepal" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8 ml-3"
                fill="currentColor"
          ...
          <div className="Github">
            <a href="https://github.com/Suraj0910" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8 ml-3 mb-2"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
